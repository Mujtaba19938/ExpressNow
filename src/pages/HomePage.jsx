...
export default function HomePage({ setPage }) {
  ...
  return (
    <div style={{ background: "#F8F8F8", minHeight: "100vh" }}>
      ...
      <div style={{ display: "flex", gap: 14, padding: "14px 16px", maxWidth: 1232, margin: "0 auto" }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
            ...
            <a href="#" style={{ fontSize: 12, color: "#FF6B00" }}>View all ›</a>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: 10, marginBottom: 18 }}>
            {categories.map(cat => (
              <div
                ...
                style={{
                  background: "#fff", border: `1.5px solid ${activeCategory === cat.name ? "#FF6B00" : "rgba(0,0,0,0.1)"}`,
              ...
              >
                ...
                <div style={{ fontSize: 12, fontWeight: 500, color: "#111" }}>{cat.name}</div>
              </div>
            ))}
          </div>
