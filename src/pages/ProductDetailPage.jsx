...
const product = {
  id: 5,
  name: "Fresh Beef Boneless — Premium Cut",
  category: "Fresh Meat",
  price: 900,
  oldPrice: 1000,
  rating: 4.5,
  reviews: 128,
  stock: true,
  description: "Our Fresh Beef Boneless is sourced daily from trusted local farms in Karachi. Each cut is carefully trimmed, inspected for quality, and packed hygienically before delivery. Ideal for karahi, stew, BBQ, and biryani. No added preservatives — pure fresh meat delivered to your door the same day you order.",
  specs: [
    ["Category", "Fresh Meat"],
    ["Type", "Beef — Boneless"],
    ["Cut", "Premium boneless chunks"],
    ["Available weights", "500g, 1kg, 2kg, 5kg"],
    ["Storage", "Refrigerate below 4°C"],
    ["Shelf life", "2 days fresh / 3 months frozen"],
    ["Origin", "Local farms, Karachi"],
    ["Halal certified", "Yes"],
  ],
  reviews_data: [
    { name: "Ahmed Raza", rating: 5, date: "2 days ago", text: "Bahut fresh meat tha, delivery bhi time pe aayi. Karahi mein use kiya, ekdum maza aa gaya. Definitely ordering again!" },
    { name: "Sana Mirza", rating: 4, date: "5 days ago", text: "Good quality, nicely packed. Same day delivery is a great feature. Will order the 2kg pack next time." },
    { name: "Hassan Khan", rating: 5, date: "1 week ago", text: "Best quality in Karachi, I've tried many places. Express Now delivers on time every time." },
  ],
};
  ...
  return (
    <div style={{ background: "#F8F8F8", minHeight: "100vh" }}>
      ...
      <div style={{ padding: "10px 16px", fontSize: 12, color: "#6B7280" }}>
        Home › Fresh & Frozen › <span style={{ color: "#FF6B00" }}>Fresh Beef Boneless</span>
      </div>
      ...
      <div style={{ display: "flex", gap: 20, padding: "0 16px", maxWidth: 1232, margin: "0 auto 24px" }}>
        ...
        <div style={{ width: 360, flexShrink: 0 }}>
          <div style={{
            background: "#f0faf4", border: "0.5px solid rgba(0,0,0,0.1)",
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: "flex", gap: 10, marginBottom: 18 }}>
            <button onClick={() => setCart(c => [...c, { ...product, qty }])} style={{
      ...
      <div style={{ maxWidth: 1232, margin: "0 auto", padding: "0 16px 28px" }}>
        <div style={{ display: "flex", borderBottom: "0.5px solid rgba(0,0,0,0.1)", marginBottom: 18 }}>
          {[["description","Description"], ["specs","Specifications"], ["reviews",`Reviews (${product.reviews})`]].map(([id, label]) => (
        ...
        {activeTab === "description" && (
          <p style={{ fontSize: 13, color: "#6B7280", lineHeight: 1.8 }}>{product.description}</p>
        )}
          ...
          <div>
            <div style={{ display: "flex", gap: 24, alignItems: "center", marginBottom: 20 }}>
              <div style={{ textAlign: "center" }}>
                <div style={{ fontSize: 44, fontWeight: 700, color: "#111", lineHeight: 1 }}>{product.rating}</div>
                <div style={{ fontSize: 11, color: "#9CA3AF", marginTop: 4 }}>{product.reviews} reviews</div>
              </div>
              <div style={{ flex: 1 }}>
