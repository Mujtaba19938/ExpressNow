...
const initialCart = [
  { id: 1, name: "Fresh Beef Boneless", subcat: "Fresh Meat", desc: "1 kg · Fresh · Premium cut", price: 900, oldPrice: 1000, qty: 1, badge: "Fresh", badgeColor: "#22C55E" },
  { id: 2, name: "Lays Chips Multipack", subcat: "Snacks", desc: "6 pcs pack", price: 320, oldPrice: 360, qty: 2, badge: null },
  { id: 3, name: "Frozen Pomfret", subcat: "Frozen Fish", desc: "500g · Cleaned & packed", price: 650, oldPrice: null, qty: 1, badge: "Frozen", badgeColor: "#3B82F6" },
];
...
export default function CartCheckoutPage({ setPage }) {
        ...
        <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{ background: "#fff", border: "0.5px solid rgba(0,0,0,0.1)", borderRadius: 14, overflow: "hidden" }}>
            <div style={{ padding: "12px 16px", borderBottom: "0.5px solid rgba(0,0,0,0.08)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <a href="#" style={{ fontSize: 12, color: "#FF6B00" }}>Continue shopping</a>
            </div>
            {cart.map(item => (
              <div key={item.id} style={{ display: "flex", alignItems: "center", gap: 14, padding: "14px 16px", borderBottom: "0.5px solid rgba(0,0,0,0.06)" }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 11, color: "#6B7280", marginBottom: 4 }}>{item.desc}</div>
                  {item.badge && (
                ...
                <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8 }}>
                  ...
                  <button onClick={() => removeItem(item.id)} style={{ fontSize: 11, color: "#9CA3AF", background: "none", border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: 3 }}>
                    <X size={11} /> Remove
                  </button>
                </div>
              </div>
